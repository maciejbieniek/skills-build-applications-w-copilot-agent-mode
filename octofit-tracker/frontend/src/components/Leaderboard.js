...
const API_BASE_URL = (() => {
  ...
  return `https://${name}-8000.app.github.dev/api/leaderboard/`;
})();
...
function Leaderboard() {
  ...
  useEffect(() => {
    console.log(`[Leaderboard] Fetching from endpoint: ${url}`);
    fetch(url)
      .then((res) => {
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-12">
          <h1 className="display-4 text-primary mb-4">Leaderboard</h1>
